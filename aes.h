...
#define AES_IN_C_MAIN_AES_H

#define EXPANDEDKEYSIZE 170
#define SIZE 16
...
// Implementation: AES encryption
unsigned char aes_encrypt(unsigned char *input, unsigned char *output, unsigned char *key, enum keySize size);
// AES Decryption
...
unsigned char aes_decrypt(unsigned char *input, unsigned char *output, unsigned char *key, enum keySize size);



#endif //AES_IN_C_MAIN_AES_H
